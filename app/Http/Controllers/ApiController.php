...
public function addToCart(Request $request){
    ...
    if($Cart->checkProductsIfExist($data['ProductID'],$data['UserID'])){
       $ResponseMessage ='This book is already in your purchase cart. Please proceed to checkout & payment';
       return response()->json([
         'response' => 'Failed',         
         'message' => $ResponseMessage,
        ]); 
...
public function getAudioBookList(Request $request)
{
    ...
    $AudioBooks= $Books->getSearchAudioBookList($data);
