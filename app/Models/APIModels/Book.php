...
class Book extends Model
{
 ...
 public function getRandomBookList($data){
    ...
    $CacheKey = 'random_book_list_' . $UserID;

    $list = Cache::remember($CacheKey, now()->addMinutes(5), function () use ($UserID) {
...
public function getSearchAudioBookList($data){
 ...
 public function getDetailsCatalogueList($data){
    ...
    $list = Cache::remember($CacheKey, now()->addHour(), function () use ($HeaderID, $UserID) {
