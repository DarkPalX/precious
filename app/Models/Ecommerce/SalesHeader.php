...
class SalesHeader extends Model
{
    ...
    protected $fillable = ['user_id', 'order_number', 'response_code', 'order_source', 'customer_name', 'customer_email', 'customer_contact_number', 'customer_address', 'customer_delivery_zip', 'customer_delivery_adress', 'delivery_tracking_number', 'delivery_fee_amount', 'delivery_fee_discount', 'delivery_courier', 'delivery_type', 'gross_amount', 'tax_amount', 'net_amount', 'discount_amount', 'ecredit_amount', 'payment_status', 'delivery_status', 'status','other_instruction','customer_type', 'payment_method'];
