        ...
        <div class="col-md-6">
            <form id="delivery_form" autocomplete="off" action="{{ route('locations.store') }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('province') is-invalid @enderror" name="province" id="province" maxlength="150" value="{{ old('province') }}" required>
                        @error('province')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror                                       
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('city') is-invalid @enderror" name="city" id="city" maxlength="150" value="{{ old('city') }}">
                        @error('city')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror                                       
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('barangay') is-invalid @enderror" name="barangay" id="barangay" maxlength="150" value="{{ old('barangay') }}">
                        @error('barangay')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror                                       
                    </div>
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control @error('rate') is-invalid @enderror text-right" name="rate" id="rate" min="1" step="0.01" onclick="select()" value="{{ old('rate',0.00) }}"> 
                        @error('rate')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror                                       
                    </div>  
