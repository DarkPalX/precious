...
@if($epub_file_exist)
  ...
  <div style="display:flex;top: 0px;right:0px;background: lightgray;height: 40px;z-index: 99999;position: fixed;">    
        ...
        <img src="https://www.beta.ebooklat.phr.com.ph/public/api/img/menu-icon.png" onclick="openSidePanelNav()" style="width: 60px;height: 60px;">                
    </div>
  </div>
                ...
                <table class="table table-style-01" style="width:100%;">
                  <tbody> 
                      ...
                      <div class="setting">
                            ...
                            <div class="setting-content" data-chips="theme">
                                <div class="theme-setting" id="light-theme" style="background: #fff; color: #000;" data-default="true" data-value="#fff;#000"></div>
                                <div class="theme-setting" id="dark-theme" style="background: #000; color: #fff;" data-value="#000;#fff"></div>                                
                                <div class="theme-setting" id="septia-theme"  style="background: #f5deb3; color: #000;" data-value="#f5deb3;#000"></div>                                
                            </div>
                        </div> 
