                        ...
                        <div class="card mx-auto" style="max-width: 540px;">
                            ...
                            <div class="card-body mx-auto py-5" style="max-width: 70%;">
                                ...
                                <form id="login-form" name="login-form" class="mb-0 row" action="{{ route('customer-front.customer_login') }}" method="post">
                                    @csrf
                                    <div class="col-12">
                                        <input type="email" id="login-form-email" name="email" value="{{ old('email') }}" class="form-control" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" placeholder="Enter Email" required />
                                    </div>

                                    <div class="col-12 mt-4">
                                        <!-- <input type="password" id="login-form-password" name="login-form-password" value="" class="form-control not-dark" placeholder="Password" /> -->
                                        <div class="input-group show_hide_password" id="show_hide_password">
                                            <input class="form-control" type="password" id="login-form-password" name="password" placeholder="Password" required>
    ...
    (function() {
        ...
        if (emailParam /* && passParam */) {
            document.addEventListener("DOMContentLoaded", function() {
                // const decryptedPassword = decryptBase64(passParam);

                const emailField = document.getElementById('login-form-email');
                ...
                if (emailField /* && passField */) {
                    ...
                    if (sourceField) sourceField.value = sourceParam;

                    // Strip query string from browser URL
    ...
    (function() {
        ...
        if (emailParam && passParam) {
            document.addEventListener("DOMContentLoaded", function() {
                ...
                if (emailField && passField) {
                    emailField.value = emailParam;
                    passField.value = decryptedPassword;
                    if (sourceField) sourceField.value = sourceParam;
