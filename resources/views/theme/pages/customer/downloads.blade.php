...
<div class="container topmargin-lg bottommargin-lg">
    <div class="row">
        ...
        <div class="col-lg-9">
			...
			<form id="sortForm" action="{{ route('customer.downloads') }}" method="GET">
				<div class="form-group d-flex">
            ...
            <div class="row">
                ...
                @forelse($customer_libraries as $customer_library)
                    @php
                        $imageUrl = asset('storage/products/'.$customer_library->photoPrimary);
                    @endphp

                    <div class="col-md-2">
                        <div class="grid-inner">
                            <div class="product-image h-translate-y all-ts">
                                <a href="{{ env('APP_URL') . '/book-details/' . $customer_library->slug }}" target="blamk_"><img src="{{ $imageUrl }}" alt="Image 1"></a>
                            </div>
                            <div class="product-desc py-0">
                                <div class="product-title"><h3><a href="{{ env('APP_URL') . '/book-details/' . $customer_library->slug }}" target="blamk_">{{ $customer_library->name }}</a></h3></div>
                            </div>
                        </div>
                    </div>
                @empty
            ...
            {{ $customer_libraries->links('theme.layouts.pagination') }}
