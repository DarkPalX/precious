					...
					<tbody>
	                    ...
	                    @forelse($cart as $key => $order)
							...
							<tr class="cart_item">
	                            ...
	                            <td class="cart-product-price" hidden>
				...
				<div class="row col-mb-30">
	                <div class="col-lg-6">
	                    <div class="col-lg-auto ps-lg-0">
	                        ...
	                        @if(Auth::check())
                                <p><a href="javascript:void(0)" onclick="myCoupons()" class="btn mb-2 text-primary px-0"> <small>or click here to  Select from My Coupons</small></a></p>
                                <input type="hidden" id="hasLogin" value="1">
	                        @else
                                <p><a href="javascript:void(0)" onclick="login_modal()" class="btn mb-2 text-primary px-0"> <small>or click here to  Select from My Coupons</small></a></p>
	                    ...
	                    <div id="couponList">
                            {{-- @foreach($coupons as $coupon)
                                ...
                                <table id="selected_coupon{{ $coupon->id }}" class="table small border rounded border-top-warning">
                                    <tbody>
                                        <tr>
                                            <td>
...
{{-- @section('pagejs')
    ...
    <script>
        ...
        function plus_qty(id){
        	...
        	var maxorder = parseInt($('#maxorder'+id).val());
        ...
        function minus_qty(id){
        	...
        	order_qty(id, 'subtract');
        }

        function order_qty(id, action){
        ...
        $('#couponManualBtn').click(function(){
            ...
            $.ajax({
                ...
                success: function(returnData) {
                    ...
                    if(returnData['min_purchase_not_met']){
                        swal({
                            title: '',
                            text: "The minimum purchase not met. Cannot use the coupon.",         
                        });
                        return false;
                    }
                    ...
                    if (returnData['success']) {
                        ...
                        if(returnData.coupon_details['end_date'] == null){
                            ...
                            if(returnData.coupon_details['end_time'] == null){
                                var validity = ' Valid Till '+returnData.coupon_details['end_date'];
                            } else {
                                var validity = ' Valid Till '+returnData.coupon_details['end_date']+' '+returnData.coupon_details['end_time'];
                            }
                        }
	                    //
                        ...
                        $('#manual-coupons').append(
                            ...
                            '<input type="hidden" id="coupondesc'+returnData.coupon_details['id']+'" value="'+returnData.coupon_details['description']+'">'+
                            '<input type="hidden" id="couponfreeproductid'+returnData.coupon_details['id']+'" value="'+returnData.coupon_details['free_product_id']+'">'+
                            '<input type="hidden" id="couponvalidity'+returnData.coupon_details['id']+'" value="'+validity+'">'
                        );
