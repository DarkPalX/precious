							...
							<div class="row justify-content-center">
								...
								<label for="shipping-option-d2d" class="col-sm-6 col-md-4">
									<div class="pricing-box text-center shadow-none border">
										...
										<div class="px-3">
											<p class="">A courier will deliver the physical item/s to your chosen delivery address.</p>
										</div>
									</div>
								</label>
								...
								<div class="row justify-content-center">
									...
									<label for="shipping-option-pickup" class="col-sm-6 col-md-4">
										<div class="pricing-box text-center shadow-none border">
											...
											<div class="px-3">
												<p class="">You will personally get the parcel from a drop-off warehouse</p>
											</div>
										</div>
									</label>
				...
				<div id="ptab3">
					...
					<div class="row justify-content-center">
							...
							<div class="col-sm-12 col-md-3 mb-2">
								<label for="payment-option-card" class="w-100">
									<div class="pricing-box text-center shadow-none border">
										...
										<div class="pricing-price">
											<h3 class="nott ls0 mb-0">Credit</h3>
										</div>
										<div class="px-3">
						...
						<div class="col-sm-12 col-md-3 mb-2">
							<label for="payment-option-card" class="w-100">
								<div class="pricing-box text-center shadow-none border">
									<input type="radio" name="payment_method" value="ewallet" class="required mt-3 payment-option" autocomplete="off" id="payment-option-card4" @if(auth()->user()->ecredits < $ordersubtotal) checked @endif>
									<div class="pricing-price">
										<h3 class="nott ls0 mb-0">E-Wallet</h3>
									</div>
									<div class="px-3">
										<p class="">Pay with Maya or GCash</p>
									</div>
								</div>
							</label>
						</div>
