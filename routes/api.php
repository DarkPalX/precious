...
Route::post('/get-top-reads-book-list',[
   'uses'=>'App\Http\Controllers\ApiController@getTopReadsBookList',
   'as'=> 'get-top-reads-book-list'
]);
...
Route::post('/get-audio-book-list',[
   'uses'=>'App\Http\Controllers\ApiController@getAudioBookList',
...
Route::post('/get-search-keywords',[
   'uses'=>'App\Http\Controllers\ApiController@getCustomerSearchKeyWords',
